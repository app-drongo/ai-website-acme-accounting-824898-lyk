...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Join thousands of small business owners who trust Acme Accounting to manage their finances. Get personalized support and start your free trial today.',
  ...
  method1Contact: 'sales@acmeaccounting.com',
  method2Title: 'Support Hotline',
  method2Description: 'Get help with your account',
  method2Contact: '+1 (555) 234-ACME',
  method3Title: 'Live Chat',
  method3Description: 'Instant help from our team',
  ...
  office2City: 'Austin',
  office2Address: '890 Business Park Drive, Floor 8',
  office2Timezone: 'CST (UTC-6)',
  office3City: 'Seattle',
  office3Address: '456 Tech Hub Boulevard, Building C',
